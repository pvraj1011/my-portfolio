                ...
                <div className="relative overflow-hidden h-48">
                  ...
                  <div className="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-30 transition-all duration-300 flex items-center justify-center">
                    <motion.button
                      ...
                      whileTap={{ scale: 0.9 }}
                      className="opacity-0 group-hover:opacity-100 bg-slate-700 text-primary-400 p-3 rounded-full shadow-lg transition-all duration-300 border border-slate-600"
                    >
                      <FaEye size={20} />
                    </motion.button>
                  </div>
                ...
                <div className="p-6">
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {project.technologies.slice(0, 4).map((tech, index) => (
                      <span
                        key={tech}
                        className="bg-primary-500/10 text-primary-600 px-2 py-1 rounded text-xs font-medium border border-primary-500/20"
                      >
                        {tech}
                      </span>
                    ))}
                  ...
                  <div className="flex gap-3">
                    <motion.a
                      ...
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                      className="flex-1 bg-gray-200 hover:bg-gray-300 text-gray-700 py-2 px-4 rounded-lg text-center font-medium transition-colors duration-200 flex items-center justify-center gap-2"
                    >
                      <FaGithub size={16} />
                      Code
                    </motion.a>
                    <motion.a
                      ...
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                      className="flex-1 bg-primary-600 hover:bg-primary-700 text-white py-2 px-4 rounded-lg text-center font-medium transition-colors duration-200 flex items-center justify-center gap-2"
                    >
              ...
              <div className="p-8">
                ...
                <div className="mb-8">
                  ...
                  <div className="flex flex-wrap gap-3">
                    {selectedProject.technologies.map((tech) => (
                      <span
                        key={tech}
                        className="bg-primary-500/10 text-primary-600 px-4 py-2 rounded-full text-sm font-medium border border-primary-500/20"
                      >
                        {tech}
                      </span>
                    ))}
                ...
                <div className="flex gap-4">
                  <motion.a
                    ...
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className="flex-1 bg-gray-200 hover:bg-gray-300 text-gray-700 py-3 px-6 rounded-lg text-center font-medium transition-colors duration-200 flex items-center justify-center gap-2"
                  >
                    <FaGithub size={20} />
                    View Source Code
                  </motion.a>
                  <motion.a
                    ...
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className="flex-1 bg-primary-600 hover:bg-primary-700 text-white py-3 px-6 rounded-lg text-center font-medium transition-colors duration-200 flex items-center justify-center gap-2"
                  >
